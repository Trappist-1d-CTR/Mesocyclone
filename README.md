...
# Copyright
Feel free to download and/or copy snippets of code and browse around the project in general. Do now, however, think about taking it all and saying it is your own work and/or idea. You can use snippets of my code for your own projects, of course (as I had to re-think and re-invent several systems like 3D data interpolation, Air Cell physics, flight physics, etc.) but always make sure to attribute me (name of project, link of project, and username will be enough) and actually expand on it with your own.
