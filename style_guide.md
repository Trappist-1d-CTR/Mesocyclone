...
camelCase
* All variables and constants on half bread's part.

PascalCase
* All variables and constants on Astraa's part. And sometimes will use a blend between PascalCase and snake_case, so don't mind that :P
